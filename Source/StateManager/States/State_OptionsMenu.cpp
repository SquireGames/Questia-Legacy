...
State_OptionsMenu::State_OptionsMenu(sf::RenderWindow &mWindow):
    ...
    , key_moveLeft (Data_Desktop::getInstance().getSaveOptions().getItem("key_moveLeft").at(0))
    , key_moveRight(Data_Desktop::getInstance().getSaveOptions().getItem("key_moveRight").at(0))
    , key_skill4   (Data_Desktop::getInstance().getSaveOptions().getItem("key_skill4").at(0))
    , key_skill5   (Data_Desktop::getInstance().getSaveOptions().getItem("key_skill5").at(0))
    , key_skill6   (Data_Desktop::getInstance().getSaveOptions().getItem("key_skill6").at(0))
